...
export default function NotificationsPage({ id }: { id: string }) {
                ...
                notifications.map((notification: NotificationWithUser) => (
                  ...
                  >
                    <li className="flex w-full gap-3 rounded-lg pt-2 sm:px-4 sm:hover:bg-accent">
                      ...
                      <div className="w-full border-b border-border_color pb-3">
...
export const getStaticProps = async (context: any) => {
  ...
  await ssg.notifications.getNotificationsByUser.prefetchInfinite({
    userId: id,
  });
