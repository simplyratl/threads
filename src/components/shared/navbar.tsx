...
function Navbar() {
  ...
  return (
    <header className="bg-background fixed bottom-0 left-0 z-50 h-20 w-full border-r px-4 py-6 md:bottom-auto md:top-0 md:h-screen md:w-20 lg:w-[330px]">
      <nav className="mx-auto flex h-full max-w-5xl flex-row justify-between md:flex-col">
        ...
        <div className="flex hidden items-center justify-between md:block">
